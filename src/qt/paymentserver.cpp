...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("helleniccoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'helleniccoin://' is not a valid URI. Use 'helleniccoin:' instead."),
            CClientUIInterface::MSG_ERROR);
    }
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // helleniccoin: URI
    {
