...
//
//     src/qt/test/test_helleniccoin-qt -platform xcb      # Linux
//     src/qt/test/test_helleniccoin-qt -platform windows  # Windows
//     src/qt/test/test_helleniccoin-qt -platform cocoa    # macOS
void TestGUI()
{
